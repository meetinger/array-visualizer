export class Sorts {
    ...
    constructor(arrayVisualizer) {
        ...
        this.sortsPaths = ["BubbleSort", "MergeSort", "LLQuickSort", "LRQuickSort", "InsertionSort", "SelectionSort", "TimSort", "PseudoTimSort", "HeapSort", "LSDRadixSort","SlowSort", "StoogeSort"]
    }
